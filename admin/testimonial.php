...
<div id="admin-content" style=" margin-top:66px; margin-left: 271px;">
     ...
     <div class="container">
          <div class="row">
               <div class="col-md-10">
                    <h1 class="admin-heading text-center text-primary mt-1">Testimonial Setting</h1>
               </div>
                         ...
                         <div class="modal-content">
                              ...
                              <div class="modal-body">
                                   ...
                                   <form id="submit_form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                             <label for="team_position" class="form-label">Testimonial text</label>
                                             <input type="text" class="form-control" id="team_position" aria-describedby="emailHelp" name="testimonial_text" required>


                                        </div>
                                        <div class="mb-3">
                                             <label for="team_name" class="form-label">Testimonial position</label>
                                             <input type="text" class="form-control" id="team_name" aria-describedby="emailHelp" name="testimonial_position">
                                             <input type="hidden" name="testimonial_insert" required>


                                        </div>
                                      
                                        <div class="mb-3">
                                             <label for="team_position" class="form-label">Testimonial name</label>
                                             <input type="text" class="form-control" id="testimonial_name" aria-describedby="emailHelp" name="testimonial_name" required>
                                        ...
                                        <div class="mb-3">
                                             ...
                                             <select class="form-select" aria-label="Default select example" name="testimonial_status" required>
               ...
               <div class="modal" id="myModalvalues">
                    <div class="modal-dialog" id="modal_values">
                         <div class="modal-content">
                              <div class="modal-header">
                                   <h4 class="modal-title">Update Testimonial value</h4>
               ...
               <div class="modal" id="Modal_imagebanner">
                    <div class="modal-dialog modal-xl" id="modal-dialog">
                         <div class="modal-content">
                              <div class="modal-header">
                                   <h4 class="modal-title">Update Testimonial Image</h4>
...
<script>
     ...
     function viewTestimonial(testimonial_id) {
     ...
     function updateTestimonialvalue(testimonial_id) {
     ...
     function viewTestimonialimage(testimonial_id) {
          var testimonial_id = testimonial_id;
     ...
     function ViewStatus(testimonial_id) {
          var testimonial_id = testimonial_id;
          Swal.fire({
